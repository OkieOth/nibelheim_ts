import {StringFilterOperator, NumericFilterOperator, FieldFilter, SortDirection, FieldSort} from "../src/mongo_helper";

export type MineFilter = FieldFilter<StringFilterOperator, string> |
